					...
					<label style="font-weight: 700;">SELECT ALL</label>
						...
						<table class='MainTable'>
							<thead class='tableheading'>
								<tr>
									<th style="color: white; font-weight: 800;">Permission</th>
									<th style="color: white; font-weight: 800;">View</th>
									<th style="color: white; font-weight: 800;">Edit</th>
									<th style="color: white; font-weight: 800;">Create</th>
									<th style="color: white; font-weight: 800;">Delete</th>
									<th style="color: white; font-weight: 800;">All Data <span style="text-transform: lowercase;">(all permission)</span></th>
								</tr>
							</thead>
