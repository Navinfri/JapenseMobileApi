								...
								<table class='MainTable'>
									<thead class='tableheading'>
										<tr>
											...
											<th style="font-weight: 800; color: white;">Question Type</th>
									...
									<tbody class='tablebody'>
										<tr>
											...
											<td style="font-size: 20px;"><a><i class="fa-regular fa-pen-to-square"
													style="font-weight: 900; color: #12e068; padding-right: 10px"></i></a> <a><i
						...
						.ready(
								function() {
										...
										$
												.ajax({
													...
													error : function(xhr,
														...
														console
																.error(
																		"Failed to fetch questions type :",
																		error);
									...
									function editQuestion(id) {
										window.location.href = "editquestype?id="
												+ id;
									}
										...
										$
												.ajax({
													...
													error : function(xhr,
														...
														console
																.error(
																		"Failed to delete questions type:",
																		error);
